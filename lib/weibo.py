...
class APIClient(object):
	...
	'''
	def __init__(self, app_key, app_secret, redirect_uri=None, response_type='code', domain='api.weibo.com', version='2', site_type='pc'):
	...
	def set_access_token(self, access_token, expires, uid):                                                                  
	...
	def get_access_token(self, code, redirect_uri=None):
		...
		r.expires = int(time.time()) + r.expires_in
		self.set_access_token(r.access_token,r.expires,r.uid)
		return r
